...
import { HighlightsPanel, TopicsPanel, SummaryPanel, MapPanel } from "../panels";
    ...
    <div>
      ...
      <div className="w-full">
        ...
        <div className="flex justify-between items-center mb-4 text-lg">
          ...
          <div className="mr-8">
            {new Date(article.datePublished).toLocaleDateString('it-IT', {
              day: 'numeric',
              month: 'short',
              year: 'numeric'
            }).replace(/^(\d+)\s([a-z]+)\s(\d+)$/i, (_, d, m, y) => 
